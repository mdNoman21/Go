...
import (
	...
	_ "github.com/lib/pq"
	"github.com/mdNoman21/Go/Beginner-Projects/postgres-golang/models"
)
...
func CreateStock(w http.ResponseWriter, r *http.Request) {
	...
	// insertStock fn will talk with the database
	res := Response{
		ID:      insertID,
...
func GetStock(w http.ResponseWriter, r *http.Request) {
	...
	// here we have a handler level function and we
	// call a database level function
...
func UpdateStock(w http.ResponseWriter, r *http.Request) {
	...
	msg := fmt.Sprintf("Stock updated successfully. Total rows/recprds affected %v", updatedRows)
	res := Response{
		ID:      int64(id),
		Message: msg,
	}
